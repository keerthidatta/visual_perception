...
class DatasetHandler:
	...
	#config calibration data
        self.k = np.array([[968.999694824 , 0, 463.537109375],
                           [0,   968.999694824 , 635.139038086],
    ...
    def _read_image(self):
        ...
        filenames = glob.glob('/images/*.ppm')
        filenames.sort()
        
        for img in filenames:

            self.images.append(cv.imread(img, flags=0))
            self.images_rgb.append(cv.imread(img)[:, :, ::-1])
